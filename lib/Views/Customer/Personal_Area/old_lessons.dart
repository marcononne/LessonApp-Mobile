...
class OldLessons extends StatefulWidget {
  const OldLessons({Key? key}) : super(key: key);

  @override
  State<OldLessons> createState() => _OldLessonsState();
}

class _OldLessonsState extends State<OldLessons> {
    final HomePageController controller = Get.find<HomePageController>();
    String username = Get.parameters['username'] as String;
    List<Lesson> _lessons = [];

    void _loadLesson() async {
        _lessons = await LessonApi().fetchUserLessons(username, "Done");
        if(_lessons == null)
          _lessons = [];
        setState(() {});
    }
            ...
            Column(
                ...
                children: [
                    Padding(
                        ...
                        child: Text(
                            "$username, you do not have any completed lessons",
